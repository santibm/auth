...
<x-auth::layouts.app title="{{ \Devdojo\Auth\Helper::trans('auth::auth.twoFactorChallenge.page_title', 'devdojo.auth.language.twoFactorChallenge.page_title', 'Two Factor Challenge') }}">
